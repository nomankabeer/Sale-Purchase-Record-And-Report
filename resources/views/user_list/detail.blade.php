                ...
                <div class="row">
                    <div class="panel-body">
                        <div class="col-md-12 w3ls-graph">
                            ...
                            <!-- gallery -->
                            <div class="gallery">
                                <h2 class="w3ls_head">{{$data['user']->first_name}} {{$data['user']->last_name}} Gallery</h2>
                                <div class="gallery-grids">
                                    <div class="gallery-top-grids">

                                        <div class="col-sm-4 gallery-grids-left">
                                            <div class="gallery-grid">
                                                <a class="example-image-link" href="{{asset($data['user']->cnic_front)}}" data-lightbox="example-set" data-title="">
                                                    <img src="{{asset($data['user']->cnic_front)}}" alt="" />
                                                    <div class="captn">
                                                        <h4>CNIC Front Picture</h4>
                                                        {{--<p>Aliquam non</p>--}}
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-sm-4 gallery-grids-left">
                                            <div class="gallery-grid">
                                                <a class="example-image-link" href="{{asset($data['user']->cnic_back)}}" data-lightbox="example-set" data-title="">
                                                    <img src="{{asset($data['user']->cnic_back)}}" alt="" />
                                                    <div class="captn">
                                                        <h4>CNIC Back Picture</h4>
                                                        {{--<p>Aliquam non</p>--}}
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="col-sm-4 gallery-grids-left">
                                            <div class="gallery-grid">
                                                <a class="example-image-link" href="{{asset($data['user']->user_picture)}}" data-lightbox="example-set" data-title="">
                                                    <img src="{{asset($data['user']->user_picture)}}" alt="" />
                                                    <div class="captn">
