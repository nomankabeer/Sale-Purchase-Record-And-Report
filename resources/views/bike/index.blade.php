        ...
        $(function() {
            ...
            $('#job-table tfoot th').each( function () {
                ...
                if(title == "Purchase From"){
                    ...
                    var purchase_from = '<?php echo @$_GET['purchase_from']; ?>';
                    ...
                    $.each(JSON.parse(purchase_user) , function(index , value){
                        var selected = null;
                        // console.log(purchase_from , "Ddddddddddd" , value.id);
                        if(purchase_from == value.id){ selected = "selected='selected'"; console.log(purchase_from , "ppppppppppppp");}
                        purchase_user_item += "<option "+selected+" value='"+value.id+"'>"+value.first_name+" "+value.last_name+"</option>";
                    });
            ...
            $('#job-table').DataTable({
                ...
                ajax: '{!! route('bike.data' , @$_GET['purchase_from']) !!}',
                columns: [
                    // { data: 'id', name: 'id' },
