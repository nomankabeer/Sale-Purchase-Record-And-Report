...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!-- //font-awesome icons -->
    <script src="{{asset('theme/js/jquery2.0.3.min.js')}}"></script>
...
<!--[if lte IE 8]>
<script language="javascript" type="text/javascript" src="{{asset('theme/js/flot-chart/excanvas.min.js')}}"></script><![endif]-->
<script src="{{asset('theme/js/jquery.scrollTo.js')}}"></script>
@stack('script')
<script>
   ...
   /* $('input[type=number]').keyup(function (evt) {
        evt = (evt) ? evt : window.event;
        var charCode = (evt.which) ? evt.which : evt.keyCode;
        if (charCode > 31 && (charCode < 48 || charCode > 57)) {
            return false;
